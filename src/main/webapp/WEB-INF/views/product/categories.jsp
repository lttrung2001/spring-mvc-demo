...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/categories_styles.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/categories_responsive.css">
</head>
...
<body>
	...
	<div class="super_container">
		...
		<header class="header trans_300">
			...
			<!-- Top Navigation -->
			<%@include file="/WEB-INF/views/product/topnavigation.jsp" %>
								...
								<div class="col">
									...
									<div id="product-list" class="product-grid">
										...
										<div
											...
											<span class="showing_results">Showing 1â3 of 12
												results</span>
											<div class="pages d-flex flex-row align-items-center">
												<div class="page_current">
													<span>1</span>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="footer_nav_container">
								<div class="cr">
									Â©2018 All Rights Reserverd. Template by <a href="#">Colorlib</a>
	...
	<script
		src="${pageContext.request.contextPath}/styles/bootstrap4/popper.js"></script>
	<script
		src="${pageContext.request.contextPath}/styles/bootstrap4/bootstrap.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/plugins/jquery-ui-1.12.1.custom/jquery-ui.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/categories_custom.js"></script>
